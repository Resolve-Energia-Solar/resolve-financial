# Generated by Django 5.0.7 on 2024-09-19 15:11
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('first_document', models.CharField(blank=True, max_length=20, null=True, unique=True, verbose_name='CPF/CNPJ')),
                ...
                ('person_type', models.CharField(blank=True, choices=[('PF', 'Pessoa Física'), ('PJ', 'Pessoa Jurídica')], max_length=2, null=True, verbose_name='Tipo de Pessoa')),
                ('second_document', models.CharField(blank=True, max_length=12, null=True, verbose_name='RG/Inscrição Estadual')),
                ...
                ('addresses', models.ManyToManyField(related_name='customer_addresses', to='accounts.address', verbose_name='Endereços')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('owners', models.ManyToManyField(blank=True, related_name='branch_owners', to=settings.AUTH_USER_MODEL, verbose_name='Proprietários')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('birth_date', models.DateField(blank=True, null=True, verbose_name='Data de Nascimento')),
                ('gender', models.CharField(choices=[('M', 'Masculino'), ('F', 'Feminino'), ('O', 'Outro')], default='M', max_length=1, verbose_name='Gênero')),
                ('first_document', models.CharField(blank=True, db_index=True, max_length=20, null=True, verbose_name='CPF/CNPJ')),
                ...
                ('phone', models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='accounts.phonenumber', verbose_name='Telefone')),
