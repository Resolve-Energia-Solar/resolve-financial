...
class SaleProduct(models.Model):
    sale = models.ForeignKey("resolve_crm.Sale", on_delete=models.CASCADE, verbose_name="Venda", related_name="products", null=True, blank=True)
    commercial_proposal = models.ForeignKey("resolve_crm.ComercialProposal", on_delete=models.CASCADE, verbose_name="Proposta Comercial", related_name="products", null=True, blank=True)
